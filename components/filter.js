...
export default function filter() {
  ...
  return (
    <div className="bg-black" id="top_hu">
      <div>
          ...
          <div className="flex items-baseline justify-between border-b border-white-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-black shadow-2xl ring-1 ring-white ring-opacity-5 focus:outline-none">
                    <div className="py-1">
